(function () {
  ...
  function hasTargetBridge() {
    return !!(
      desktopBridge &&
      typeof desktopBridge.choose_static_web_target === "function" &&
      typeof desktopBridge.analyze_static_web_target === "function" &&
      typeof desktopBridge.generate_static_web_patch === "function"
    );
  }
  ...
  function applyLocale() {
    ...
    if (targetLang) targetLang.textContent = locale === "zh" ? "中 / EN" : "EN / 中";
  ...
  function targetEligibleCapsules() {
    return (data && Array.isArray(data.capsules) ? data.capsules : []).filter(function (cap) {
